...
data.to_csv("./data/sarc-preprocessed_annotation_global.csv")
...
data.to_csv("./data/sarc-preprocessed_Matrix_meth.csv")
...
data = data[~data["Composite Element REF"].isin(cases_removed["case_id"])]
data = data.sort_values(by="Composite Element REF")
data.to_csv("./data/sarc-preprocessed_Matrix_miRNA_deseq_correct.csv")
...
data = data[~data["Composite Element REF"].isin(cases_removed["case_id"])]
data = data.sort_values(by="Composite Element REF")
data.to_csv("./data/sarc-preprocessed_Matrix_mRNA_deseq_normalized_prot_coding_correct.csv")
